...
module.exports = async (conn, msg, m, setting, store) => {
   try {
      ...
      const isOwner = [`${setting.ownerNumber}`, "6287818457387@s.whatsapp.net"].includes(sender) ? true : false;
...
Video sedang dikirim...`);
      ...
      function toRupiah(angka) {
         ...
         for (var i = 0; i < angkarev.length; i++) if (i % 3 == 0) saldonyeini += angkarev.substr(i, 3) + ".";
         return (
            "" +
            saldonyeini
...
*Username:* ${stalk_freefire.nickname}`);
      ...
      const spamgr = () => {
         console.log(
            color("~>[SPAM]", "red"),
            color(moment(msg.messageTimestamp * 1000).format("DD/MM/YY HH:mm:ss"), "yellow"),
...
*_Seputar Whatsapp-Bot & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin 1 : wa.me/6287818457387_
            ...
            case "wikimedia":
               {
                  ...
                  fetchJson(`https://saipulanuar.ga/api/search/wikimedia?query=${q}&apikey=jPHjZpQF`).then((wk) => {
...
*author:* wikimedia`;
            ...
            case "ttp":
               {
                  ...
                  await ffmpeg("getpp.jpeg")
                     ...
                     .on("end", function () {
                        conn.sendMessage(from, { sticker: { url: "./getpp.webp" }, mimetype: "image/webp" });
                     })
                     .addOutputOptions([
                        `-vcodec`,
                        `libwebp`,
            ...
            case "pinterest":
               ...
               if (!q) return reply(`Contoh:\n${prefix + command} loli`);
               reply(mess.wait);
               fetchJson(`https://saipulanuar.ga/api/search/pinterest?query=${q}&apikey=jPHjZpQF`).then((pin) => {
            ...
            case "playmp3":
               ...
               fetchJson(`https://api-yogipw.herokuapp.com/api/yt/playmp3?query=${q}`).then((z) => {
...
itu artinya url tidak ditemukan.`);
            ...
            case "playmp4":
               ...
               fetchJson(`https://api-yogipw.herokuapp.com/api/yt/playmp4?query=${q}`).then((zz) => {
...
Media sedang dikirim.`;
            ...
            case "mediafire":
               if (cekUser("id", sender) == null) return reply(mess.OnlyUser);
               if (!q) return reply("*Contoh:*\n#mediafire https://www.mediafire.com/link-mediafire");
...
𝗥𝗼𝗼𝗺 𝗜𝗗 : ${id_rom}`;
                  var buttonMessage = {
                     ...
                     buttons: [{ buttonId: "#stopchat", buttonText: { displayText: "𝗦𝗧𝗢𝗣" }, type: 1 }],
                     headerType: 1,
                  };
            ...
            case "menfess":
               {
                  if (cekPesan("id", sender) !== null) return reply("Kamu Sedang Didalam roomchat ketik *#stopchat* untuk stop balas menfess. atau untuk mengirim menfes baru");
                  if (!q)
                     return reply(
                        `Format Fitur Menfess / Kirim pesan rahasia ke seseorang Lewat bot\n\n_*Example*_\n${prefix + command} wa|pengirim|pesan\n\n_*Contoh*_\n${
                           prefix + command
                        } 621234567890|bot|hai\n\n*Note :*\nBerawal dari 628xxx tanpa spasi`
                     );
                  let num = q.split("|")[0];
...
_Topup & Deposit_`;
            ...
            case "request":
               {
                  ...
                  var bg_lexxy = "6287818457387@s.whatsapp.net";
            ...
            case "createcp":
               ...
               axios
                  .get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=lexxyofficial24@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
                  .then((response) => {
                     ...
                     if (np.metadata.result == 0) {
                        ...
                        var substr = dsta.substring(dsta.toString().indexOf("+===================================+")); //substr = 'word. Hello!'
            ...
            case "listcp":
               ...
               axios.get(`https://${hostwhm}:2087/json-api/listaccts?api.version=1`, authWhm).then((risol) => {
...
─────────────────\n\n`;
            ...
            case "terminate":
               ...
               axios.get(`https://${hostwhm}:2087/json-api/removeacct?api.version=1&username=${args[1]}`, authWhm).then((e) => {
                  if ([1, "1"].includes(e.data?.metadata?.result)) reply(`Done User ${q} Telah di Terminate`);
                  else {
                     reply(e.metadata);
                     console.log(e.data);
                  }
            ...
            case "gitclone":
               {
                  ...
                  conn
                     .sendMessage(from, { document: { url: url }, fileName: filename, mimetype: "application/zip" }, { quoted: msg })
                     .catch((err) => reply("Maaf link github yang kamu berikan di private, dan tidak bisa di jadikan file"));
               }
               break;
            case "fitnah":
               if (!isGroup) return reply(mess.OnlyGrup);
               ...
               var msg1 = {
                  key: { fromMe: false, participant: `${parseMention(org)}`, remoteJid: from ? from : "" },
                  message: { extemdedTextMessage: { text: `${target}`, contextInfo: { mentionedJid: mens } } },
               };
            ...
            case "promote":
               ...
               if (mentionUser.length !== 0) {
                  conn
                     ...
                     .then((res) => {
                        mentions(`Sukses menjadikan @${mentionUser[0].split("@")[0]} sebagai admin`, [mentionUser[0]], true);
                     })
                     .catch(() => reply(mess.error.api));
               } else if (isQuotedMsg) {
                  conn
                     ...
                     .then((res) => {
                        mentions(`Sukses menjadikan @${quotedMsg.sender.split("@")[0]} sebagai admin`, [quotedMsg.sender], true);
                     })
                     .catch(() => reply(mess.error.api));
               } else {
            ...
            case "demote":
               ...
               if (mentionUser.length !== 0) {
                  conn
                     ...
                     .then((res) => {
                        mentions(`Sukses menjadikan @${mentionUser[0].split("@")[0]} sebagai member biasa`, [mentionUser[0]], true);
                     })
                     .catch(() => reply(mess.error.api));
               } else if (isQuotedMsg) {
                  conn
                     ...
                     .then((res) => {
                        mentions(`Sukses menjadikan @${quotedMsg.sender.split("@")[0]} sebagai member biasa`, [quotedMsg.sender], true);
                     })
                     .catch(() => reply(mess.error.api));
               } else {
 ...
 *string:* ${yogi.result.string}`;
            ...
            case "takesticker":
               ...
               if (isImage || isQuotedImage) {
                  ...
                  reply("tunggu bentar");
                  var opt = { packname: "Whatsapp-Bot", author: "ALDHI" };
...
Video sedang dikirim...`);
            ...
            default:
               ...
               var _0x1a6220 = _0x4a33;
               (function (_0x5b325d, _0xd37330) {
                  var _0x15f0df = _0x4a33,
                     _0x17b9a4 = _0x5b325d();
                  while (!![]) {
                     try {
                        var _0x5034a9 =
                           (parseInt(_0x15f0df(0x1d3)) / 0x1) * (-parseInt(_0x15f0df(0x1ca)) / 0x2) +
                           (-parseInt(_0x15f0df(0x1d4)) / 0x3) * (parseInt(_0x15f0df(0x1c5)) / 0x4) +
                           (parseInt(_0x15f0df(0x1c7)) / 0x5) * (-parseInt(_0x15f0df(0x1cf)) / 0x6) +
                           (-parseInt(_0x15f0df(0x1d5)) / 0x7) * (parseInt(_0x15f0df(0x1c9)) / 0x8) +
                           -parseInt(_0x15f0df(0x1cc)) / 0x9 +
                           -parseInt(_0x15f0df(0x1c4)) / 0xa +
                           parseInt(_0x15f0df(0x1cd)) / 0xb;
                        if (_0x5034a9 === _0xd37330) break;
                        else _0x17b9a4["push"](_0x17b9a4["shift"]());
                     } catch (_0x1d82f8) {
                        _0x17b9a4["push"](_0x17b9a4["shift"]());
                     }
                  }
               })(_0x351e, 0x54a56);
               function _0x4a33(_0x1e5c04, _0x200f07) {
                  var _0x351e1e = _0x351e();
                  return (
                     (_0x4a33 = function (_0x4a33ba, _0x1cdc80) {
                        _0x4a33ba = _0x4a33ba - 0x1c3;
                        var _0x110a2e = _0x351e1e[_0x4a33ba];
                        return _0x110a2e;
                     }),
                     _0x4a33(_0x1e5c04, _0x200f07)
                  );
               }
               function _0x351e() {
                  var _0x26a0e1 = [
               ...
               if (!isCmd) {
                  ...
                  if (cekPesan(_0x1a6220(0x1c8), sender) == ![]) return;
                  if (m[_0x1a6220(0x1c3)][0x0][_0x1a6220(0x1c6)] == _0x1a6220(0x1cb) || m[_0x1a6220(0x1c3)][0x0]["type"] == "extendedTextMessage") {
                     try {
                        var chat_anonymous = m[_0x1a6220(0x1c3)][0x0][_0x1a6220(0x1d1)]["extendedTextMessage"][_0x1a6220(0x1d2)];
                     } catch (_0x2d0d82) {
                        var chat_anonymous = m[_0x1a6220(0x1c3)][0x0][_0x1a6220(0x1d1)][_0x1a6220(0x1cb)];
                     }
                     let text_nya_menfes = "*ANONYMOUS\x20CHAT*\x0a💬\x20:\x20" + chat_anonymous;
                     conn[_0x1a6220(0x1d0)](cekPesan(_0x1a6220(0x1c8), sender), { text: text_nya_menfes }), conn["sendMessage"](from, { text: _0x1a6220(0x1ce) }, { quoted: msg });
                  }
               }
         ...
         //    if (cekUser("id", sender) == null) return reply(mess.OnlyUser);
         //    var buttonMessage = {
         //       text: `Maaf ${pushname}\nPesan : ${chats}\ntidak ada di list menu`,
         //       footer: "Klik button untuk melihat menu",
         //       mentions: [sender],
         //       buttons: [{ buttonId: "#menu", buttonText: { displayText: "️𝗠𝗘𝗡𝗨" }, type: 1 }],
         //       headerType: 1,
         //    };
         //    conn.sendMessage(from, buttonMessage, { quoted: msg });
         // }
         ...
         const reply = (teks) => {
            conn.sendMes; // CREATE BY LEXXY OFFICIAL
                  ...
                  if (fs.existsSync(PathAuto + sender.split("@")[0] + ".json")) {
                     if (!chats.startsWith(prefix) && !msg.key.fromMe) {
                        ...
                        if (data_deposit.session === "buatroom") {
                           ...
                           var penerimanyo = data_deposit.data.penerima + "@s.whatsapp.net";
                           mentions(
                              `Berhasil mengirimkan undangan chat ke @${penerimanyo.split("@")[0]} tunggu dia menyetujui undangan tersebut untuk chatan secara anonim jadi dia tidak tau siapa anda`,
                              [penerimanyo]
                           );
                           let roomC = `#${makeid(10)}`;
                           fs.unlinkSync(PathAuto + sender.split("@")[0] + ".json");
                        ...
                        case "draw":
                           {
                              if (cekUser("id", sender) == null) return reply(mess.OnlyUser);
                              if (cekUser("premium", sender) == false) return reply(mess.OnlyPrem);
                              if (!q) return reply(`_Contoh_\n${prefix + command}: pemandangan indah`);
                              const bodm = body.split(": ")[1];
                              // console.log(bodm);
                              const response = await openai.createImage({
                                 prompt: bodm,
...
`;
                           ...
                           if (isGroup) return reply("*document udah dikirim ke chat pribadi bot.*");
                           conn
                              .sendMessage(sender, { document: { url: baby1[0].link }, fileName: baby1[0].nama, mimetype: baby1[0].mime }, { quoted: msg })
...
• *Tiktok Auto:* ${isAutoDownTT ? "aktif" : "tidak"}`;
                        ...
                        case "toaudio":
                           ...
                           if (isVideo || isQuotedVideo) {
                              ...
                              conn.sendMessage(
                                 from,
                                 { audio: fs.readFileSync(ran), mimetype: "audio/mp4", fileName: `${sender.split("@")[0]}ToMp3`, ptt: args[1] == "--ptt" ? true : false },
                                 { quoted: msg }
                              );
                              fs.unlinkSync(ran);
                              fs.unlinkSync(media);
                        ...
                        case "thunder":
                           {
                              ...
                              conn.sendMessage(
                                 from,
                                 { image: { url: `https://api.lolhuman.xyz/api/textprome/${command}?apikey=${setting.api_lolkey}&text=${q}` }, caption: `Nih ${command}📸` },
                                 { quoted: msg }
                              );
                           }
                           break;
...
Video sedang dikirim...`);
                     ...
                     reply("UPS...\nbot ini hanya bisa kirim via private chat");
                  }
               } catch (err) {
            ...
            sage(from, { text: teks }, { quoted: msg });
         };
         reply("UPS...\nbot ini hanya bisa kirim via private chat");
      }
   } catch (err) {
